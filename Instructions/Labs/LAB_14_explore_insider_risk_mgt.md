<!---
---
랩: 제목: 'Microsoft Purview의 내부 위험 관리 기능 살펴보기' 학습 경로/모듈/단원: '학습 경로: Microsoft 규정 준수의 기능 설명, 모듈 4: Microsoft Purview의 내부 위험 기능 설명, 단원 2: 내부 위험 관리 기능 설명'
---
--->
...
1. 내부 위험 관리 개요 페이지에서 **정책** 탭을 선택한 다음 **+ 정책 만들기**를 선택합니다.  다음의 각 정책 탭을 구성합니다.
    ...
    1. 기본 또는 고객 표시기 임계값을 사용할지 여부를 결정하는 페이지에서 Microsoft**에서 제공하는 기본 설정 **적용 임계값을 그대로 두고 다음**을 선택합니다**.
