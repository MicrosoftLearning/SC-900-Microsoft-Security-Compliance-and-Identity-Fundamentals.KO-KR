...
1. 정책 설정을 검토합니다.  아무 설정도 변경하지 마세요.  페이지 아래쪽의 **다음** 을 선택합니다.
    1. "문서에 기본 레이블 적용" 아래에 있는 설명을 읽습니다.  기본 레이블이 없습니다. 아무 설정도 변경하지 마세요.  페이지 아래쪽의 **다음** 을 선택합니다.
    1. "이메일에 기본 레이블 적용" 아래에 있는 설명을 읽습니다.  입력 상자에서 드롭다운 화살표를 선택하여 사용 가능한 옵션을 확인합니다. 아무 설정도 변경하지 마세요.  페이지 아래쪽의 **다음** 을 선택합니다.
    1. "Power BI 콘텐츠에 기본 레이블 적용" 아래에 있는 설명을 읽습니다.  기본 레이블이 없습니다. 아무 설정도 변경하지 마세요.  페이지 아래쪽의 **다음** 을 선택합니다.
