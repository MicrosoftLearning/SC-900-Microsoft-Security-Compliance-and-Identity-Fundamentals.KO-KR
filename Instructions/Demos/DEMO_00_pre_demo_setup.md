...
1. 왼쪽 탐색 패널의 솔루션 아래에서 **감사**를 선택합니다.  참고: Microsoft 365 Defender 홈 페이지를 통해 감사 기능에 액세스할 수도 있습니다.
...
이 설정 작업에서는 Microsoft Defender for Cloud Apps에서 파일 모니터링을 사용하도록 설정합니다.

1. 브라우저 탭을 열고 Microsoft 365 관리 센터로 이동합니다.  이전에 브라우저 탭을 닫았다면 새 브라우저 탭을 열고 주소 표시줄에 **https://admin.microsoft.com**을 입력한 후 Microsoft 365 관리 센터의 왼쪽 탐색 창에서 **모두 표시**를 선택합니다.

1. 관리 센터 아래에서 **보안**을 선택합니다.  새 브라우저 페이지가 열리고 Microsoft 365 Defender 포털 시작 페이지가 표시됩니다.  

1. 왼쪽 탐색 패널에서 클라우드 앱 아래의 **파일**을 선택합니다.

1. 파일 모니터링을 아직 사용하도록 설정하지 않았다면 **파일 모니터링 사용**을 선택하고 **파일 모니터링 사용** 옆의 확인란을 선택한 후에 **저장**을 선택해야 합니다.  

1. 왼쪽 탐색 패널의 클라우드 앱에서 **파일**을 선택하여 파일 페이지로 돌아옵니다.  파일 모니터링이 사용하도록 설정되면 페이지 위쪽에 필터 옵션이 표시됩니다.  미리 구성된 랩 테넌트의 파일이 표시되려면 시간이 다소 걸릴 수 있습니다.
